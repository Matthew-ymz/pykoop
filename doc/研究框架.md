...
\tag{3.9}$$
其中 ddd 是对应状态空间的维数，$$\Gamma_{\alpha}^{\mathrm{GIS}}$$如式（3.2）所定义。
基于此，宏观效率增益定义为
...
- 第一类系统参数扫描奇异值谱箱型图  
  ![第一类系统参数扫描奇异值谱箱型图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part1_spectrum_boxplot.png)

- 第一类系统固定参数轨迹相图  
  ![第一类系统固定参数轨迹相图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part1_phase.png)

- 解析矩阵 A 热力图  
  ![解析矩阵 A 热力图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part2_A_heatmap.png)

- 第二部分解析矩阵A奇异值谱图  
  ![第二部分奇异值谱图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part2_svd_spectrum.png)

- 解析矩阵实验中的粗粒化矩阵 W 热力图  
  ![解析矩阵实验中的粗粒化矩阵 W 热力图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part2_W_heatmap.png)

- 第三部分含噪轨迹与干净轨迹对比图  
  ![含噪轨迹与干净轨迹对比图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part3_noisy_vs_clean.png)

-第三部分拟合矩阵A/Kraw热力图  
  ![解析矩阵 A 热力图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part3_A_heatmap.png)

- 第三部分标准差热力图  
  ![第三部分标准差热力图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part3_sigma_heatmap.png)

- 第三部分微观层预测曲线图  
  ![第三部分微观层和宏观层预测曲线图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part3_prediction.png)

- 第三部分拟合矩阵A/Kraw奇异值谱图  
  ![第二部分奇异值谱图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part3_svd_spectrum.png)

- 解析矩阵实验中的粗粒化矩阵 W 热力图  
  ![解析矩阵实验中的粗粒化矩阵 W 热力图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part3_W_heatmap.png)

- 第三部分宏观预测图  
  ![第三部分宏观预测图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part3_mac_prediction.png)

- 第三部分宏微观曲线对比图  
  ![第三部分宏微观曲线对比图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part3_micro_macro_curve.png)

- step2 系统轨迹相图  
  ![step2 系统轨迹相图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part4_step2_phase.png)

- step2 系统奇异值谱与特征值谱对比图  
  ![step2 系统奇异值谱与特征值谱对比图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part4_svd_vs_evd_spectrum.png)

- step2 系统中 SVD / EVD 粗粒化矩阵对比图  
  ![step2 系统中 SVD / EVD 粗粒化矩阵对比图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part4_W_compare.png)

- step2 系统中 SVD / EVD 宏微观曲线对比图  
  ![step2 系统中 SVD / EVD 宏微观曲线对比图](E:/code/pykoop/exp/analysitic_exp/figs/exp_ana_gis_part4_curve_compare.png)
